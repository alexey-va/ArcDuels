...
dependencies {
    ...
    testImplementation("ru.ruscrafting.arc:arc-core-testing:2.7.9")
}
...
dependencies {
    add(integrationTest.implementationConfigurationName, "ru.ruscrafting.arc:arc-core-integration-testing:2.7.9")
}
